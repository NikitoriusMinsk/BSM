...
const MatchesPage: NextPage = () => {
	...
	const { data: matches, isLoading: matchesLoading } =
		trpc.matches.getAllByLeague.useQuery({
			leagueId: Array.from(
				new Set(selectedLeagues.concat(selectedTopLeagues))
			),
			page: 0,
			size:
			...
			<PortalContext.Provider value={{ portalNode }}>
				...
				<div className={styles.filters}>
					...
					<NestedFilter
						...
						h3="BY COUNTRY"
						h2="Choose Matches"
						onChange={(countries, leagues) =>
							setSelectedTopLeagues(leagues)
						}
					/>
					<NestedFilter
						items={leagues}
				...
				>
					...
					/>
					<div className={styles.wideBook1366}>
