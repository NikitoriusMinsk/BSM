		...
		<div className={styles.currentCompetition}>
			...
			<div className={styles.duration}>
				...
				<span className={styles.text}>
					...
					Mauris semper arcu vitae neque sollicitudin lobortis vitae sit amet
					quam. Proin viverra nulla in tellus dictum faucibus. Proin a dictum
					nulla. Duis euismod venenatis semper. Mauris sed volutpat elit, eget
					egestas nulla. Pellentesque vitae consequat ipsum.
				</span>
			</div>
		</div>
	);
