...
const OddsPage: React.FC = () => {
	...
	const createOdd = (key: any) => {
		if (oddInProcess) setOddInProcess(undefined);
		...
		<div className={styles.pageContainer}>
			...
			<div className={styles.oddsContent}>
				...
				<div className={styles.oddsBlock}>
					<span
						className={styles.oddsBlockTitle}
					...
					<div
						...
						className={`${styles.odd} ${
							"1" == oddInProcess && styles.oddActive
						}`}
						onClick={() => createOdd("1")}
					>
				...
				<div
					className={styles.oddsBlock}
					aria-colcount={3}
				>
					<span
						className={styles.oddsBlockTitle}
						style={{ color: "rgba(26, 28, 33, 0.7)" }}
					>
				...
				<div
					...
					aria-colcount={3}
				>
					<span className={styles.oddsBlockTitle}>Total</span>
					<div className={styles.oddsColTitle}></div>
					<div className={styles.oddsColTitle}>More</div>
					<div className={styles.oddsColTitle}>Less</div>
